...
- `lib/graph-module-core/src/core/identity.ts` already adds the first graph types
...
- `lib/graph-module-core/src/core/identity.ts` already establishes the beginning
  of that model.
