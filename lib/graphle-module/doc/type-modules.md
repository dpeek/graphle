...
description: "Type-module metadata, filter contracts, field overrides, and packaged defaults in @dpeek/graphle-module."
...
- reusable scalar and enum authoring helpers layered above `@dpeek/graphle-kernel`
