...
import { liveScopeRequestKindValues } from "@dpeek/graphle-live";
import { type LiveScopeRouter } from "@dpeek/graphle-live/server";
import {
...
export const webAppAuthorizationContextHeader = "x-graphle-authorization-context";
