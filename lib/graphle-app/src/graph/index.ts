 ...
 *
 * Internal callers should prefer the owning package (`@dpeek/graphle-kernel`,
 * `@dpeek/graphle-authority`, `@dpeek/graphle-bootstrap`, and friends) over this umbrella
 * barrel. Module-definition authoring now lives on `@dpeek/graphle-module`; this
...
export { sanitizeSvgMarkup, type SvgSanitizationResult } from "@dpeek/graphle-module-core";
