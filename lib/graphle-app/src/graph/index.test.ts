...
describe("@dpeek/graphle-app/graph package entry surfaces", () => {
  ...
  it("keeps the root and module-authoring surfaces focused", async () => {
    const [rootExports, moduleExports] = await Promise.all([
      import("@dpeek/graphle-app/graph"),
      import("@dpeek/graphle-module"),
    ]);
    ...
    const retiredDefSubpath = "@dpeek/graphle-app/graph/def";
    await expect(import(retiredDefSubpath)).rejects.toThrow();
    const retiredRuntimeSubpath = "@dpeek/graphle-app/graph/runtime";
    await expect(import(retiredRuntimeSubpath)).rejects.toThrow();
    const retiredAuthoritySubpath = "@dpeek/graphle-app/graph/authority";
    await expect(import(retiredAuthoritySubpath)).rejects.toThrow();
    const retiredReactDomAdapterSubpath = "@dpeek/graphle-app/graph/adapters/react-dom";
    await expect(import(retiredReactDomAdapterSubpath)).rejects.toThrow();
    const retiredReactDomSubpath = "@dpeek/graphle-app/graph/react-dom";
  ...
  it("keeps graph-react host-neutral while module-core owns the DOM defaults", async () => {
    const [graphReactExports, coreReactDomExports] = await Promise.all([
      import("@dpeek/graphle-react"),
      import("@dpeek/graphle-module-core/react-dom"),
    ]);
    ...
    const retiredReactDomPackage = "@dpeek/graphle-react-dom";
  ...
  it("keeps the canonical module entry surfaces explicit", async () => {
    const [coreModuleExports, coreReactDomExports, workflowExports] = await Promise.all([
      import("@dpeek/graphle-module-core"),
      import("@dpeek/graphle-module-core/react-dom"),
      import("@dpeek/graphle-module-workflow"),
    ]);
    ...
    const retiredModulesSubpath = "@dpeek/graphle-app/graph/modules";
    await expect(import(retiredModulesSubpath)).rejects.toThrow();
    const retiredCoreModulesSubpath = "@dpeek/graphle-app/graph/modules/app";
    await expect(import(retiredCoreModulesSubpath)).rejects.toThrow();
    const retiredWorkflowSubpath = "@dpeek/graphle-app/graph/modules/workflow";
