...
describe("@dpeek/graphle-module-core/react-dom", () => {
  it("keeps the subpath surface focused on core-owned browser defaults", async () => {
    const adapterExports = await import("@dpeek/graphle-module-core/react-dom");
