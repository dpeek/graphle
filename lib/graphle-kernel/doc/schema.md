...
description: "Schema authoring, normalized field trees, and predicate authority metadata in @dpeek/graphle-kernel."
...
It does not bootstrap schema into facts, enforce policy at runtime, or provide typed client helpers. Those layers live above `@dpeek/graphle-kernel`.
