...
description: "Canonical graph write envelopes, snapshot diff helpers, and retained-history contracts in @dpeek/graphle-kernel."
...
- `../../graph-sync/doc/sync-stack.md`: cross-package ownership boundary with `@dpeek/graphle-sync` and `@dpeek/graphle-authority`
