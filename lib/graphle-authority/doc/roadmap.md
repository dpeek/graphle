...
description: "Future retained-record and durable restore direction centered on @dpeek/graphle-authority."
...
- `@dpeek/graphle-authority` owns the shared retained-record contract, durable load
