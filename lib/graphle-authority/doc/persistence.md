...
description: "Persisted authority runtime, startup recovery, durable commit boundaries, and the Node JSON adapter in @dpeek/graphle-authority."
...
- it is exported only from `@dpeek/graphle-authority/server`
