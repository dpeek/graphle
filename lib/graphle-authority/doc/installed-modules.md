...
description: "Installed-module ledger validation and lifecycle planning in @dpeek/graphle-authority."
...
1. `@dpeek/graphle-app` resolves built-in manifest sources directly and resolves one
...
- Keep authored manifest parsing in `@dpeek/graphle-module`; this package starts at the authoritative ledger seam.
