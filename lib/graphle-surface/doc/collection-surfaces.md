...
description: "Collection-surface binding and query-container runtime behavior in @dpeek/graphle-surface."
...
- `../../../lib/graphle-query/README.md`: underlying query-container runtime
...
- the route-neutral runtime wrapper over `@dpeek/graphle-query`
