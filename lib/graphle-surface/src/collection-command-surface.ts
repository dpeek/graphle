...
export type CollectionCommandBinding = {
...
export type ResolvedCollectionCommandBinding = {
  ...
  readonly surface: GraphCommandSurfaceSpec;
  readonly execute: CollectionCommandBinding["execute"];
};
...
function resolveBindingLabel(binding: CollectionCommandBinding): string {
  return binding.surface.label?.trim() || binding.surface.command;
}

function toResolvedBinding(binding: CollectionCommandBinding): ResolvedCollectionCommandBinding {
  return {
...
export function createEntityCollectionCommandSubject(
...
export function createSelectionCollectionCommandSubject(
...
export function resolveCollectionCommandBindings(
  ...
  bindings: Readonly<Record<string, CollectionCommandBinding>>,
