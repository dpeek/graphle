...
test("maps v2 notifications into codex session events", () => {
  expect(
    toCodexNotificationEvent({
      ...
      params: {
        item: {
          aggregatedOutput: "## main\n M lib/cli/src/agent/runner/codex.ts\n",
          exitCode: 1,
          id: "call-1",
          status: "failed",
...
test("default turn sandbox includes checkout and local origin", () => {
  const sandbox = createDefaultTurnSandbox({
    branchName: "ope-43",
    controlPath: "/Users/dpeek/code/graphle",
    createdNow: false,
    originPath: "/Users/dpeek/code/graphle",
    path: "/Users/dpeek/code/graphle/tmp/workspace/workers/worker-1/repo",
    sourceRepoPath: "/Users/dpeek/code/graphle",
    workerId: "worker-1",
  });
  ...
  expect(sandbox).toMatchObject({
    type: "workspaceWrite",
    writableRoots: [
      "/Users/dpeek/code/graphle/tmp/workspace/workers/worker-1/repo",
      "/Users/dpeek/code/graphle",
      "/Users/dpeek/code/graphle/.git",
    ],
  });
});
