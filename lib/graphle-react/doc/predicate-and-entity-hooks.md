...
description: "Predicate hooks, metadata readers, and entity traversal helpers in @dpeek/graphle-react."
...
It does not own typed refs themselves. Those stay in `@dpeek/graphle-client`.
...
- Keep typed ref construction in `@dpeek/graphle-client`.
