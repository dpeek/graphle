      ...
      fields: [
        {
          ...
          kind: "entity-ref",
          label: "Project",
          options: [{ label: "Graphle", value: "workflow-project:graphle" }],
        },
        {
          control: "enum",
          fieldId: "state",
...
describe("query editor component", () => {
  it("renders the form-first authoring sections with typed field controls", () => {
    ...
    draft = updateQueryEditorFilter(
      ...
      draft.filters[0]!.id,
      {
        fieldId: "projectId",
        operator: "eq",
        value: { kind: "literal", value: "workflow-project:graphle" },
      },
      catalog,
    );
  ...
  it("renders freeform text entry for entity-ref filters without enumerated options", () => {
    ...
    expect(html).toContain('data-query-editor-control="entity-ref"');
    expect(html).toContain('value="project:graphle"');
