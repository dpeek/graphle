...
description: "Browser query editor, default renderers, and shared query-container chrome in @dpeek/graphle-query/react-dom."
...
- you are changing `@dpeek/graphle-query/react-dom`
...
- it reuses `QueryEditorPredicateField` so supported single-value field kinds can compose shared `@dpeek/graphle-module-core/react-dom` editors instead of inventing a second field system
