...
description: "Editor catalog, draft lifecycle, serialization, normalization, and hydration boundaries in @dpeek/graphle-query."
...
- serialization and normalization back through `@dpeek/graphle-client`
