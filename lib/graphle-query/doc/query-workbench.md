...
description: "Route-neutral draft hydration, browser storage, preview runtime, and save helpers in @dpeek/graphle-query."
...
- the storage key defaults to `graphle.web.query-workbench`
