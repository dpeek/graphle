...
description: "Installed query-surface registry, renderer compatibility, and editor-catalog projection in @dpeek/graphle-query."
...
- `@dpeek/graphle-app` resolves built-in manifests plus one repo-local `./...` local
