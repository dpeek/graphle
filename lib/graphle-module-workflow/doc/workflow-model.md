...
description: "Built-in workflow namespace assembly, schema ownership, and the browser-first v1 operator model in @dpeek/graphle-module-workflow."
...
- Put concrete `workflow:` schema in this package, not in `@dpeek/graphle-module`.
