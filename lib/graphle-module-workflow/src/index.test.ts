...
import { core, secretHandle } from "@dpeek/graphle-module-core";
...
describe("workflow module entry surfaces", () => {
  ...
  it("keeps workflow explicit while core lives in @dpeek/graphle-module-core", () => {
  ...
  it("publishes a built-in manifest for the canonical workflow module", () => {
    expect(workflowManifest).toMatchObject({
      ...
      source: {
        kind: "built-in",
        specifier: "@dpeek/graphle-module-workflow",
