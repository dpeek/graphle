...
description: "Sync scopes, payload shapes, diagnostics, and state contracts in @dpeek/graphle-sync."
...
- Keep transport and HTTP concerns outside this package; `@dpeek/graphle-sync` stops at the shared sync-core contract.
