...
description: "Local validation lifecycle, runtime invariants, and result surfaces in @dpeek/graphle-client."
...
`@dpeek/graphle-client` owns the shared public validation shape:
