...
- you need to decide whether future work belongs in `@dpeek/graphle-client`,
  `@dpeek/graphle-module`, or `@dpeek/graphle-react`
...
- definition-time authoring in `@dpeek/graphle-module`
- runtime evaluation in `@dpeek/graphle-client`
- host-neutral hooks in `@dpeek/graphle-react`
