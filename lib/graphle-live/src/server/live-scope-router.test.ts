...
import { createLiveScopeRouter } from "./live-scope-router.js";
import type { LiveScopeRegistrationTarget } from "../live-scope.js";

function createRegistrationTarget(
  overrides: Partial<LiveScopeRegistrationTarget> = {},
