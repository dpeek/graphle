    ...
    >
      <select
        ...
        className={cn(
          ...
          "data-[multiple=true]:h-auto data-[multiple=true]:min-h-24 data-[multiple=true]:pr-2 data-[multiple=true]:py-1.5 data-[multiple=true]:text-xs/relaxed",
          selectClassName,
        )}
        {...props}
      />
