...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@dpeek/graphle-web-ui/sheet";
import { Skeleton } from "@dpeek/graphle-web-ui/skeleton";
import { Tooltip, TooltipContent, TooltipTrigger } from "@dpeek/graphle-web-ui/tooltip";
import { useIsMobile } from "@dpeek/graphle-web-ui/use-mobile";
  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "flex w-(--sidebar-width) self-stretch flex-col bg-sidebar text-sidebar-foreground",
          className,
        )}
        {...props}
      >
