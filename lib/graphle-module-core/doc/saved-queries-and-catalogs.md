...
description: "Durable saved-query or saved-view records plus the package-root core catalog and read-scope contract in @dpeek/graphle-module-core."
...
dispatch and installed-catalog composition belong in `@dpeek/graphle-query`,
`@dpeek/graphle-client`, and the host runtime.
