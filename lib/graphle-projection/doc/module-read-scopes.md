...
description: "Named module read-scope definitions, registrations, and sync interop in @dpeek/graphle-projection."
...
`@dpeek/graphle-sync`, `@dpeek/graphle-authority`, and host code.
...
Those fallback reasons come from `@dpeek/graphle-sync` and are the fail-closed
