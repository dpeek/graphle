...
- `../../src/graph/react/`, `../../src/graph/react-dom/`, `../../src/graph/react-opentui/`: reserved adapter entry surfaces kept separate from the root-safe package export
- `../../src/graph/schema/`: canonical namespace-shaped schema tree for core modules and graph-owned app slices
- `../../src/graph/taxonomy/`: root-safe slice aggregators over canonical schema modules
