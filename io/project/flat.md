...
- many internal imports that primarily use config module names as aliases
...
1. Move `src/agent/*` to `src/agent/*`.
2. Move `src/app/*` to `src/app/*`.
3. Move `src/cli/*` to `src/cli/*`.
4. Move `src/config/*` to `src/config/*`.
5. Move `src/graph/*` to `src/graph/*`.
6. Move `src/lib/*` to `src/lib/*`.
